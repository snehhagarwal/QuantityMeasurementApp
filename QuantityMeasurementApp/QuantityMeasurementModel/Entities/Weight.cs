...
namespace QuantityMeasurementModel.Entities
{
    ...
    /// Conversion logic duplicates WeightUnitExtensions constants to avoid circular dependency.
    /// </summary>
    public class Weight
    {
        ...
        {
            if (obj == null || obj.GetType() != typeof(Weight)) return false;
            return ToBaseUnit().Equals(((Weight)obj).ToBaseUnit());
        }
