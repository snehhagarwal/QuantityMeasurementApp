...
namespace QuantityMeasurementBusinessLayer.Service
{
    ...
    ///   DIP  — depends on IQuantityMeasurementEntityRepository abstraction (injected).
    /// </summary>
    public class QuantityMeasurementServiceImpl : QuantityMeasurementBusinessLayer.Interface.IQuantityMeasurementService
    {
        private readonly IQuantityMeasurementEntityRepository _repository;

        public QuantityMeasurementServiceImpl(IQuantityMeasurementEntityRepository repository)
        {
    ...
    {
        public bool AreEqualWithTolerance(QuantityMeasurementModel.Units.Feet first,
                                          QuantityMeasurementModel.Units.Feet second,
                                          double tolerance)
        {
            if (tolerance < 0)
    ...
    {
        public bool AreEqualWithTolerance(QuantityMeasurementModel.Units.Inches first,
                                          QuantityMeasurementModel.Units.Inches second,
                                          double tolerance)
        {
            if (tolerance < 0)
                throw new System.ArgumentException("Tolerance cannot be negative.", nameof(tolerance));
    ...
    {
        public bool AreEqualWithTolerance(QuantityMeasurementModel.Units.Length first,
                                          QuantityMeasurementModel.Units.Length second,
                                          double tolerance)
        {
            if (tolerance < 0)
                throw new System.ArgumentException("Tolerance cannot be negative.", nameof(tolerance));
