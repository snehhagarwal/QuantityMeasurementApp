...
namespace QuantityMeasurementApp
{
    ...
    public class Program
    {
        public static void Main()
        {
            ...
            // UC12
            var subDivUI         = new SubtractionAndDivisionPresentation();
            // UC14
            var temperatureUI    = new TemperaturePresentation();
            ...
            while (true)
            {
                ...
                Console.WriteLine("11. Subtraction and Division");
                ...
                switch (choice)
                {
                    ...
                    case 11: subDivUI.Run();         break;
                    case 12: temperatureUI.Run();    break;
                    case 0:
