...
namespace QuantityMeasurementApp.BusinessLogicLayer
{
    ...
    public class VolumeService : IVolumeService
    {
        ...
        /// <inheritdoc/>
        public Quantity<VolumeUnitMeasurable> Subtract(Quantity<VolumeUnitMeasurable> first,
                                                        Quantity<VolumeUnitMeasurable> second,
                                                        int decimalPlaces = 2)
        {
            return _repository.Subtract(first, second, decimalPlaces);
        }
        ...
        public Quantity<VolumeUnitMeasurable> Subtract(Quantity<VolumeUnitMeasurable> first,
                                                        ...
                                                        int decimalPlaces = 2)
        {
            return _repository.Subtract(first, second, targetUnit, decimalPlaces);
        }

        /// <inheritdoc/>
        public double Divide(Quantity<VolumeUnitMeasurable> first, Quantity<VolumeUnitMeasurable> second)
        {
            return _repository.Divide(first, second);
        }
    }
}