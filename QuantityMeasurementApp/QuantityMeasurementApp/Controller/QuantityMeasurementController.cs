...
namespace QuantityMeasurementApp.Controller
{
    ...
    public class QuantityMeasurementController : IQuantityMeasurementApp
    {
        ...
        /// <summary>Default constructor — wires dependencies internally. Called from Program.cs.</summary>
        ...
        {
            IReadOnlyList<QuantityMeasurementModel.Dto.QuantityMeasurementEntity> history
