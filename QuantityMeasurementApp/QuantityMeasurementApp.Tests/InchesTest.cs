...
{
    /// <summary>
    /// Unit Test Class for Inches Entity and InchesService.
    ///
    /// Purpose:
    /// Validate equality comparison, input validation and tolerance logic
    /// for Inches measurement.
    ///
    /// Covers:
    /// • Equality scenarios (same, different, null, reference, type safety)
