...
namespace QuantityMeasurementApp.Tests
{
    ...
    public class DatabaseRepositoryTests
    {
        ...
        private IQuantityMeasurementEntityRepository _repo = null!;
        ...
        public void testRepositoryFactory_CreateDatabaseRepository()
        {
            ...
            IQuantityMeasurementEntityRepository repo = new InMemoryDatabaseTestRepository();

            Assert.IsNotNull(repo);
            Assert.IsTrue(repo is IQuantityMeasurementEntityRepository);
        }
        ...
        /// </summary>
        private class InMemoryDatabaseTestRepository : IQuantityMeasurementEntityRepository
        {
