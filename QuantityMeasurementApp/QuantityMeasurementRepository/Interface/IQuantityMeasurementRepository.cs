...
namespace QuantityMeasurementRepository.Interface
{
    public interface IQuantityMeasurementRepository
    {
        ...
        Task<IReadOnlyList<QuantityMeasurement>> FindAllByUserAsync(long userId, CancellationToken cancellationToken = default);
        ...
        Task<IReadOnlyList<QuantityMeasurement>> FindByOperationTypeAndUserAsync(string operationType, long userId, CancellationToken cancellationToken = default);
        ...
        Task<IReadOnlyList<QuantityMeasurement>> FindByIsErrorTrueAndUserAsync(long userId, CancellationToken cancellationToken = default);
        ...
        Task<int> DeleteAllByUserAsync(long userId, CancellationToken cancellationToken = default);
    }
}
